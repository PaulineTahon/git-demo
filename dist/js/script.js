...
/******/ 	var hotCurrentHash = "e42299ebd8a0c1fcc82b"; // eslint-disable-line no-unused-vars
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, 288, 505, Phaser.AUTO));
...
var Bird = function (_Phaser$Sprite) {
  ...
  function Bird(game, x, y, frame) {
    ...
    var _this = _possibleConstructorReturn(this, (Bird.__proto__ || Object.getPrototypeOf(Bird)).call(this, game, x, y, 'bird', frame));
...
var Ground = function (_Phaser$TileSprite) {
  ...
  function Ground(game, x, y, width, height) {
    ...
    var _this = _possibleConstructorReturn(this, (Ground.__proto__ || Object.getPrototypeOf(Ground)).call(this, game, x, y, width, height, 'ground'));
...
var Pipe = function (_Phaser$Sprite) {
  ...
  function Pipe(game, x, y, frame) {
    ...
    var _this = _possibleConstructorReturn(this, (Pipe.__proto__ || Object.getPrototypeOf(Pipe)).call(this, game, x, y, 'pipe', frame));
...
var PipeGroup = function (_Phaser$Group) {
  ...
  function PipeGroup(game, parent) {
    ...
    var _this = _possibleConstructorReturn(this, (PipeGroup.__proto__ || Object.getPrototypeOf(PipeGroup)).call(this, game, parent));
...
var _Ground = __webpack_require__(2);

var _Ground2 = _interopRequireDefault(_Ground);

var _PipeGroup = __webpack_require__(4);
...
var Play = function (_Phaser$State) {
  ...
  _createClass(Play, [{
    ...
    value: function create() {
      ...
      this.bird = new _Bird2.default(this.game, 100, this.game.height / 2);
    ...
    value: function update() {
      ...
      this.pipes.forEach(function (pipeGroup) {
        _this2.checkScore(pipeGroup);
        _this2.physics.arcade.collide(_this2.bird, pipeGroup, _this2.pipeHitHandler, null, _this2);
      });
    }
  }, {
    key: 'generatePipes',
    value: function generatePipes() {
      var pipeY = this.rnd.integerInRange(-100, 100);
      var pipeGroup = this.pipes.getFirstExists(false);
      if (!pipeGroup) {
        pipeGroup = new _PipeGroup2.default(this.game, this.pipes);
      }
    ...
    key: 'checkScore',
    value: function checkScore(pipeGroup) {
